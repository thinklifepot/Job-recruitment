...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Thinklife</b> Portal</span>
    </a>
          ...
          if($result->num_rows > 0) {
            ...
            <div class="attachment-block clearfix">
              ...
              <div class="attachment-pushed">
                <h4 class="attachment-heading"><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle']; ?></a> <span class="attachment-heading pull-right">$<?php echo $row['minimumsalary']; ?>/Month</span></h4>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2020<a href="http://thinklife-pot.com/" target="_blank">Thinklife Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>

            ...
            <div class="row">
              <form method="post" action="addpost.php">
                <div class="col-md-12 latest-job ">
                  ...
                  <div class="form-group">
                    <textarea class="form-control input-lg" id="" name="description" placeholder="Job Description"></textarea>
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control  input-lg" id="minimumsalary"  autocomplete="off" name="salary" placeholder="Minimum Salary" required="">
                  </div>

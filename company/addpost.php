...
if(isset($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO job_post(id_company, jobtitle, description, minimumsalary, experience, qualification) VALUES (?, ?, ?, ?, ?, ?)");

	$stmt->bind_param("isssss", $_SESSION['id_company'], $jobtitle, $description, $minimumsalary, $experience, $qualification);

	$jobtitle = mysqli_real_escape_string($conn, $_POST['jobtitle']);
	$description = mysqli_real_escape_string($conn, $_POST['description']);
	$minimumsalary = mysqli_real_escape_string($conn, $_POST['salary']);

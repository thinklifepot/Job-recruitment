          ...
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="fname" name="fname" pattern=".{3,}" title="three or more characters" placeholder="First Name *" required>
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="lname" name="lname" pattern=".{3,}" title="three or more characters" placeholder="Last Name *" required>
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="email" id="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Email *" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label>Year you finished school or will finish school</label>
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="stream" name="stream" placeholder="course">
              </div>                    
            ...
            <div class="col-md-6 latest-job ">
              <div class="form-group">
                <input class="form-control input-lg" type="password" id="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters" placeholder="Password *" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label style="color: red;">File Format .PDF and .Docs Only!</label>
                <input type="file" name="resume" class="btn btn-flat btn-danger" required>
              </div>


              <div class="form-group checkbox">
                <label><input type="checkbox" id="field_terms"  required  onchange="this.setCustomValidity(validity.valueMissing ? 'Please indicate that you accept the Terms and Conditions' : '');" > I accept <a href="#">terms & conditions</a></label>
              </div>
              <div class="form-group">
